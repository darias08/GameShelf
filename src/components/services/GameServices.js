...
const IGDB_HTTP_REQUEST_MOST_ANTICIPATED = () => {
    ...
    return axios({
        ...
        data: `fields name, summary, hypes, age_ratings.rating, age_ratings.content_descriptions.description, involved_companies.company.parent.name, involved_companies.company.logo.image_id, artworks.image_id, involved_companies.company.name,
        genres.name, similar_games.*,
...
const getImage = (path) => `${IGDB_IMAGE_ID}/${path}.png`;
